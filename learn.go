...
var (
	...
	// Bell states.
	b00 = T2Ket([][]complex64{{1, 0}, {0, 1}}).Mul(1. / math.Sqrt2)
	b01 = T2Ket([][]complex64{{1, 0}, {0, -1}}).Mul(1. / math.Sqrt2)
	b10 = T2Ket([][]complex64{{0, 1}, {1, 0}}).Mul(1. / math.Sqrt2)
	b11 = T2Ket([][]complex64{{0, 1}, {-1, 0}}).Mul(1. / math.Sqrt2)
...
func T2Ket(s [][]complex64) *Dense {
	return &Dense{Axis: []Axis{{System: 1, Braket: Ket}, {System: 2, Braket: Ket}}, D: tensor.T2(s)}
}
